...
export type NodeWhereInput = {
  ...
  expiry?: Prisma.DateTimeFilter<"Node"> | Date | string
}
...
export type NodeScalarWhereWithAggregatesInput = {
  ...
  expiry?: Prisma.DateTimeWithAggregatesFilter<"Node"> | Date | string
}
...
export type NodeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "expiry", ExtArgs["result"]["node"]>
...
export interface NodeFieldRefs {
  ...
  readonly expiry: Prisma.FieldRef<"Node", 'DateTime'>
}
